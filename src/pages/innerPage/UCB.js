...
import imageData from "../../content/UCB.json";
        ...
        <div className={styles.contentArea}>
          ...
          <div className={styles.rightArea}>
            ...
            <div>
              ...
              <div className={styles.contentWord}>{projectIntro[`introduction-${lang}`]}</div>
            </div>
                ...
                <div key={index}>
                  ...
                  {section.content &&
                    section.content.map((content, index) => (
                      <div className={styles.contentWord} key={index}>{content}</div>
                    ))}
                  ...
                  {section.image && (
                    <>
                      <img
                        src={require(`../../img/UCB/${section.image}`)}
                  ...
                  {section.video && (
                    <>
                      <video controls width="100%">
                        <source src={require(`../../img/UCB/${section.video}`)} type="video/mp4" />
                      </video>
                      <div className={styles.imgWord}>{section.imageWord}</div>
                    </>
                  )}
